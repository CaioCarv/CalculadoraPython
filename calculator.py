...
from PyQt5.QtWidgets import QLineEdit, QSizePolicy, QPushButton
...
class Calculadora(QMainWindow):
  def __init__(self, parent=None):
    ...
    self.display.setStyleSheet(
      '* {background: white; color: #000000; font-size: 30px;}'
    )
    ...
    self.add_btn(QPushButton('<-'), 1, 3, 1, 1, lambda: self.display.setText(self.display.text()[:-1]), 'background: #ff6266; color: black; font-weight: 700;')
    self.add_btn(QPushButton('C'), 1, 4, 1, 1, lambda: self.display.setText(''),
      'background: #ff6266; color: black; font-weight: 700;')
    ...
    self.add_btn(QPushButton('='), 4, 4, 1, 1, self.eval_igual, 'background: #71c4f0; color: black; font-weight: 700;')
